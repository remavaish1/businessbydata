      ...
      <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-20 items-center">
          <div className="flex-shrink-0">
            <Link to="/" className="text-xl md:text-2xl font-bold tracking-tighter text-zinc-900">
    ...
    <footer className="bg-zinc-50 border-t border-zinc-100 py-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          <div>
            <h3 className="text-xs font-semibold text-zinc-900 uppercase tracking-widest mb-4">Navigation</h3>
            <ul className="space-y-3">
              <li><Link to="/services" className="text-sm text-zinc-500 hover:text-zinc-900">Services</Link></li>
              <li><Link to="/portfolio" className="text-sm text-zinc-500 hover:text-zinc-900">Portfolio</Link></li>
              <li><Link to="/about" className="text-sm text-zinc-500 hover:text-zinc-900">Founder</Link></li>
              <li><Link to="/contact" className="text-sm text-zinc-500 hover:text-zinc-900">Contact</Link></li>
            </ul>
          </div>
          <div>
            <h3 className="text-xs font-semibold text-zinc-900 uppercase tracking-widest mb-4">Location</h3>
            <p className="text-sm text-zinc-500">Lagos, Nigeria</p>
            <p className="text-sm text-zinc-500 mt-2">hello@businessbydata.com</p>
            <div className="mt-4">
              <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer" className="text-sm text-zinc-500 hover:text-zinc-900 flex items-center gap-2">
